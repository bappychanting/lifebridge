...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form method="POST" action="<?php echo route('admin/items/update'); ?>"> 
      ...
      <a href="<?php echo route('admin/items/show', ['id' => $item['id']]) ?>" class="btn btn-primary btn-sm my-3"><span class="oi oi-arrow-left pr-2"></span>Go Back</a>
